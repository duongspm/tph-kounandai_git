(function($){
	$(function(){
		...
		* next, backのアイコンhtml
		* */
		var backBtnIcn = '<img src="../../../sustainability/common/common/imgs/btn-prev.svg">',
			nextBtnIcn = '<img src="../../../sustainability/common/common/imgs/btn-next.svg">';

		/*
		* next, backのリンクhtml
		* */
		var backBtnHTML = '<a class="NextBack__btn NextBack__btn--back" href="../../../sustainability/common/js/' + back + '.html">' + backBtnIcn + '</a>',
			nextBtnHTML = '<a class="NextBack__btn NextBack__btn--next" href="../../../sustainability/common/js/' + next + '.html">' + nextBtnIcn + '</a>';
